...
<title>Reset Password | ICH</title>
<link href="https://fonts.googleapis.com/css2?family=Space+Mono:wght@400;700&family=Syne:wght@400;600;700;800&display=swap" rel="stylesheet">
<style>
*{box-sizing:border-box;margin:0;padding:0}
:root{--bg:#f0f2f8;--surface:#fff;--border:#e4e8f2;--border2:#cdd4e8;--accent:#4f46e5;--text:#1c2340;--text2:#4a5578;--muted:#8a94b0}
...
<div class="page">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="sub">Set your new password below. Make sure it is strong and memorable.</p>
